...
| Worker sessions | 178 | 987 | 4,486 | 7,071 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-sonnet-4-6 | 94,155 | 99K | 34.4M | 5,753.0M | $2,825.63 | $15,533.14 | $8,972.82 |
| claude-opus-4-6 | 7,055 | 7K | 2.4M | 573.3M | $1,377.15 | $7,740.88 | $0.00 |
...
| **Total** | **183,044** | **112.3M** | **55.6M** | **11,089.5M** | **$6,355.82** | **$33,452.50** | **$17,408.32** |

_11,523.4M total tokens processed. 96.2% cache hit rate._

_$50,860.82 total saved ($33,452.50 caching + $17,408.32 model routing vs all-Opus)._
...
| Model | Requests | Input | Output | Cache read | API Cost | Cache savings | Model savings |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-sonnet-4-6 | 115,177 | 121K | 43.2M | 6,797.7M | $3,398.81 | $18,354.03 | $10,754.90 |
| claude-opus-4-6 | 7,264 | 7K | 2.5M | 591.3M | $1,423.93 | $7,983.85 | $0.00 |
...
| **Total** | **234,118** | **150.0M** | **72.5M** | **14,116.6M** | **$8,643.69** | **$44,386.46** | **$22,101.61** |

_14,718.8M total tokens processed. 95.9% cache hit rate._

_$66,488.07 total saved ($44,386.46 caching + $22,101.61 model routing vs all-Opus)._
...
<!-- UPDATED-START -->
_Stats auto-updated 2026-07-19 20:23 UTC by [aidevops](https://aidevops.sh) pulse._
<!-- UPDATED-END -->
