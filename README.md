...
| Interactive sessions | 10 | 65 | 297 | 497 |
| Worker sessions | 130 | 1,132 | 4,363 | 6,895 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-sonnet-4-6 | 88,609 | 93K | 32.3M | 5,260.4M | $2,590.52 | $14,203.15 | $8,253.78 |
...
| gpt-5.4 | 4,290 | 16.0M | 1.0M | 246.8M | $125.78 | $462.81 | $487.02 |
...
| **Total** | **179,432** | **115.4M** | **54.0M** | **10,646.0M** | **$6,004.49** | **$31,790.37** | **$16,877.63** |

_11,069.0M total tokens processed. 96.2% cache hit rate._

_$48,668.00 total saved ($31,790.37 caching + $16,877.63 model routing vs all-Opus)._
...
| Model | Requests | Input | Output | Cache read | API Cost | Cache savings | Model savings |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-sonnet-4-6 | 109,496 | 115K | 41.0M | 6,297.3M | $3,159.75 | $17,002.86 | $10,022.71 |
...
| **Total** | **226,308** | **146.0M** | **69.7M** | **13,440.8M** | **$8,153.24** | **$42,077.92** | **$21,142.13** |

_14,016.2M total tokens processed. 95.9% cache hit rate._

_$63,220.05 total saved ($42,077.92 caching + $21,142.13 model routing vs all-Opus)._
...
<!-- UPDATED-START -->
_Stats auto-updated 2026-07-17 22:30 UTC by [aidevops](https://aidevops.sh) pulse._
<!-- UPDATED-END -->
