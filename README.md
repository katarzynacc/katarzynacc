...
| Worker sessions | 278 | 1,592 | 5,107 | 8,479 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-sonnet-4-6 | 53,871 | 59K | 20.0M | 6,640.9M | $3,202.90 | $17,930.69 | $9,173.76 |
...
| gpt-5.6-luna | 2,043 | 19.9M | 160K | 34.9M | $26.62 | $94.25 | $290.84 |
| claude-haiku-4-5 | 2,242 | 12K | 420K | 122.1M | $16.99 | $87.98 | $203.58 |
| **Total** | **73,865** | **81.5M** | **24.5M** | **8,101.7M** | **$4,908.91** | **$24,958.08** | **$11,774.62** |

_8,472.7M total tokens processed. 95.6% cache hit rate._

_$36,732.70 total saved ($24,958.08 caching + $11,774.62 model routing vs all-Opus)._
...
| Model | Requests | Input | Output | Cache read | API Cost | Cache savings | Model savings |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-sonnet-4-6 | 128,235 | 138K | 46.7M | 11,176.4M | $5,430.89 | $30,176.54 | $16,218.75 |
...
| **Total** | **196,515** | **169.9M** | **62.7M** | **15,797.7M** | **$9,854.28** | **$51,350.82** | **$23,501.87** |

_16,468.9M total tokens processed. 95.9% cache hit rate._

_$74,852.69 total saved ($51,350.82 caching + $23,501.87 model routing vs all-Opus)._
...
<!-- UPDATED-START -->
_Stats auto-updated 2026-08-18 06:11 UTC by [aidevops](https://aidevops.sh) pulse._
<!-- UPDATED-END -->
