...
| Interactive sessions | 25 | 76 | 310 | 521 |
| Worker sessions | 199 | 1,008 | 4,507 | 7,092 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-sonnet-4-6 | 94,955 | 100K | 34.8M | 5,813.0M | $2,854.72 | $15,695.23 | $9,065.66 |
| claude-opus-4-6 | 7,057 | 7K | 2.4M | 573.4M | $1,377.44 | $7,741.06 | $0.00 |
...
| **Total** | **183,846** | **112.3M** | **56.0M** | **11,149.5M** | **$6,385.20** | **$33,614.76** | **$17,501.16** |

_11,585.4M total tokens processed. 96.2% cache hit rate._

_$51,115.92 total saved ($33,614.76 caching + $17,501.16 model routing vs all-Opus)._
...
| Model | Requests | Input | Output | Cache read | API Cost | Cache savings | Model savings |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-sonnet-4-6 | 115,977 | 122K | 43.6M | 6,857.8M | $3,427.90 | $18,516.11 | $10,847.74 |
| claude-opus-4-6 | 7,266 | 7K | 2.5M | 591.4M | $1,424.21 | $7,984.03 | $0.00 |
...
| **Total** | **234,920** | **150.0M** | **72.9M** | **14,176.6M** | **$8,673.06** | **$44,548.72** | **$22,194.44** |

_14,780.8M total tokens processed. 95.9% cache hit rate._

_$66,743.16 total saved ($44,548.72 caching + $22,194.44 model routing vs all-Opus)._
...
<!-- UPDATED-START -->
_Stats auto-updated 2026-07-19 21:24 UTC by [aidevops](https://aidevops.sh) pulse._
<!-- UPDATED-END -->
