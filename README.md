...
| Worker sessions | 38 | 1,115 | 5,101 | 9,316 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-sonnet-4-6 | 45,777 | 50K | 16.9M | 6,222.8M | $2,945.76 | $16,801.68 | $8,487.08 |
...
| gpt-5.5-fast | 111 | 477K | 23K | 13.8M | $5.14 | $37.52 | $23.80 |
| **Total** | **65,208** | **79.9M** | **21.1M** | **7,560.1M** | **$4,281.64** | **$23,174.40** | **$10,943.56** |

_7,895.5M total tokens processed. 95.8% cache hit rate._

_$34,117.96 total saved ($23,174.40 caching + $10,943.56 model routing vs all-Opus)._
...
| Model | Requests | Input | Output | Cache read | API Cost | Cache savings | Model savings |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-sonnet-4-6 | 135,088 | 145K | 49.2M | 12,077.5M | $5,822.63 | $32,609.40 | $17,451.36 |
...
| **Total** | **205,378** | **177.7M** | **65.6M** | **16,818.4M** | **$10,364.57** | **$54,691.77** | **$24,920.02** |

_17,525.6M total tokens processed. 96% cache hit rate._

_$79,611.79 total saved ($54,691.77 caching + $24,920.02 model routing vs all-Opus)._
...
<!-- UPDATED-START -->
_Stats auto-updated 2026-08-24 08:20 UTC by [aidevops](https://aidevops.sh) pulse._
<!-- UPDATED-END -->
