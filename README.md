...
| Worker sessions | 260 | 1,486 | 4,835 | 7,997 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-sonnet-4-6 | 58,286 | 63K | 21.6M | 6,698.2M | $3,177.23 | $18,085.32 | $9,336.75 |
...
| gpt-5.6-luna | 1,714 | 15.9M | 138K | 31.1M | $21.75 | $84.15 | $237.00 |
| claude-haiku-4-5 | 2,357 | 13K | 441K | 127.8M | $17.66 | $92.02 | $213.00 |
| **Total** | **80,101** | **78.4M** | **26.6M** | **8,319.7M** | **$5,043.35** | **$26,137.83** | **$12,041.38** |

_8,673.6M total tokens processed. 95.9% cache hit rate._

_$38,179.21 total saved ($26,137.83 caching + $12,041.38 model routing vs all-Opus)._
...
| Model | Requests | Input | Output | Cache read | API Cost | Cache savings | Model savings |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-sonnet-4-6 | 124,099 | 133K | 45.0M | 10,501.4M | $5,059.88 | $28,353.92 | $15,306.45 |
...
| **Total** | **191,183** | **162.3M** | **60.8M** | **15,029.2M** | **$9,376.66** | **$49,072.26** | **$22,396.94** |

_15,652.2M total tokens processed. 96% cache hit rate._

_$71,469.20 total saved ($49,072.26 caching + $22,396.94 model routing vs all-Opus)._
...
<!-- UPDATED-START -->
_Stats auto-updated 2026-08-16 00:26 UTC by [aidevops](https://aidevops.sh) pulse._
<!-- UPDATED-END -->
