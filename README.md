...
| Worker sessions | 190 | 907 | 4,336 | 7,272 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-sonnet-4-6 | 93,042 | 98K | 34.1M | 5,836.0M | $2,853.09 | $15,757.23 | $9,052.13 |
| claude-opus-4-6 | 7,439 | 7K | 2.5M | 623.0M | $1,546.28 | $8,410.94 | $0.00 |
...
| **Total** | **180,778** | **112.3M** | **54.7M** | **11,121.4M** | **$6,474.25** | **$34,052.70** | **$17,328.08** |

_11,552.6M total tokens processed. 96.3% cache hit rate._

_$51,380.77 total saved ($34,052.70 caching + $17,328.08 model routing vs all-Opus)._
...
| Model | Requests | Input | Output | Cache read | API Cost | Cache savings | Model savings |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-sonnet-4-6 | 119,087 | 126K | 44.8M | 7,148.1M | $3,562.42 | $19,300.08 | $11,270.25 |
| claude-opus-4-6 | 7,648 | 8K | 2.6M | 641.0M | $1,593.06 | $8,653.90 | $0.00 |
...
| **Total** | **238,421** | **150.0M** | **74.2M** | **14,516.6M** | **$8,976.43** | **$46,002.56** | **$22,616.95** |

_15,134.5M total tokens processed. 95.9% cache hit rate._

_$68,619.52 total saved ($46,002.56 caching + $22,616.95 model routing vs all-Opus)._
...
<!-- UPDATED-START -->
_Stats auto-updated 2026-07-21 06:25 UTC by [aidevops](https://aidevops.sh) pulse._
<!-- UPDATED-END -->
