...
| Worker sessions | 379 | 1,194 | 4,838 | 7,858 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-sonnet-4-6 | 86,373 | 91K | 31.2M | 5,537.6M | $2,723.55 | $14,951.79 | $8,523.56 |
...
| **Total** | **175,217** | **120.1M** | **52.1M** | **10,941.1M** | **$6,517.38** | **$33,821.63** | **$17,016.95** |

_11,378.0M total tokens processed. 96.2% cache hit rate._

_$50,838.58 total saved ($33,821.63 caching + $17,016.95 model routing vs all-Opus)._
...
| Model | Requests | Input | Output | Cache read | API Cost | Cache savings | Model savings |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-sonnet-4-6 | 124,568 | 132K | 46.8M | 7,593.3M | $3,794.46 | $20,501.92 | $11,923.10 |
...
| **Total** | **245,452** | **158.3M** | **76.6M** | **15,104.9M** | **$9,412.19** | **$47,893.05** | **$23,526.77** |

_15,753.5M total tokens processed. 95.9% cache hit rate._

_$71,419.82 total saved ($47,893.05 caching + $23,526.77 model routing vs all-Opus)._
...
<!-- UPDATED-START -->
_Stats auto-updated 2026-07-23 15:25 UTC by [aidevops](https://aidevops.sh) pulse._
<!-- UPDATED-END -->
