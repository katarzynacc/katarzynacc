...
| Worker sessions | 266 | 1,271 | 4,901 | 8,164 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-sonnet-4-6 | 89,050 | 94K | 32.2M | 5,829.8M | $2,866.40 | $15,740.47 | $8,928.94 |
...
| **Total** | **177,873** | **119.9M** | **53.0M** | **11,230.6M** | **$6,666.55** | **$34,603.49** | **$17,417.00** |

_11,679.8M total tokens processed. 96.2% cache hit rate._

_$52,020.48 total saved ($34,603.49 caching + $17,417.00 model routing vs all-Opus)._
...
| Model | Requests | Input | Output | Cache read | API Cost | Cache savings | Model savings |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-sonnet-4-6 | 127,248 | 135K | 47.7M | 7,885.4M | $3,937.31 | $21,290.60 | $12,328.48 |
...
| **Total** | **248,163** | **158.3M** | **77.5M** | **15,397.0M** | **$9,562.79** | **$48,681.94** | **$23,932.17** |

_16,058.0M total tokens processed. 95.9% cache hit rate._

_$72,614.11 total saved ($48,681.94 caching + $23,932.17 model routing vs all-Opus)._
...
<!-- UPDATED-START -->
_Stats auto-updated 2026-07-25 03:02 UTC by [aidevops](https://aidevops.sh) pulse._
<!-- UPDATED-END -->
