...
| Worker sessions | 251 | 1,096 | 4,635 | 8,487 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-sonnet-4-6 | 92,283 | 98K | 33.2M | 6,328.1M | $3,089.12 | $17,086.09 | $9,589.36 |
...
| claude-sonnet-4-5 | 13,457 | 35K | 3.3M | 535.5M | $295.57 | $1,445.91 | $842.59 |
...
| **Total** | **155,813** | **121.2M** | **48.4M** | **10,425.4M** | **$6,742.11** | **$34,669.77** | **$15,889.94** |

_10,853.8M total tokens processed. 96.1% cache hit rate._

_$50,559.71 total saved ($34,669.77 caching + $15,889.94 model routing vs all-Opus)._
...
| Model | Requests | Input | Output | Cache read | API Cost | Cache savings | Model savings |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-sonnet-4-6 | 130,481 | 138K | 48.7M | 8,383.7M | $4,160.03 | $22,636.22 | $12,988.90 |
...
| **Total** | **254,214** | **171.3M** | **79.1M** | **16,110.0M** | **$9,967.45** | **$50,611.04** | **$25,037.53** |

_16,801.0M total tokens processed. 95.9% cache hit rate._

_$75,648.57 total saved ($50,611.04 caching + $25,037.53 model routing vs all-Opus)._
...
<!-- UPDATED-START -->
_Stats auto-updated 2026-07-28 23:44 UTC by [aidevops](https://aidevops.sh) pulse._
<!-- UPDATED-END -->
