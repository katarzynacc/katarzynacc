...
| Worker sessions | 342 | 1,511 | 5,414 | 9,245 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-sonnet-4-6 | 46,090 | 50K | 16.9M | 6,073.5M | $2,914.40 | $16,398.50 | $8,303.97 |
...
| gpt-5.6-luna | 2,609 | 26.2M | 181K | 37.1M | $6.76 | $100.37 | $370.28 |
| **Total** | **65,383** | **78.9M** | **21.0M** | **7,396.2M** | **$4,251.95** | **$22,732.04** | **$10,728.17** |

_7,734.8M total tokens processed. 95.6% cache hit rate._

_$33,460.21 total saved ($22,732.04 caching + $10,728.17 model routing vs all-Opus)._
...
| Model | Requests | Input | Output | Cache read | API Cost | Cache savings | Model savings |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-sonnet-4-6 | 132,640 | 142K | 48.2M | 11,637.2M | $5,649.45 | $31,420.50 | $16,863.11 |
...
| **Total** | **202,761** | **176.7M** | **64.6M** | **16,363.5M** | **$10,185.32** | **$53,463.49** | **$24,299.46** |

_17,061.6M total tokens processed. 95.9% cache hit rate._

_$77,762.95 total saved ($53,463.49 caching + $24,299.46 model routing vs all-Opus)._
...
<!-- UPDATED-START -->
_Stats auto-updated 2026-08-22 19:34 UTC by [aidevops](https://aidevops.sh) pulse._
<!-- UPDATED-END -->
