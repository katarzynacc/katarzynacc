...
| Worker sessions | 342 | 1,346 | 4,976 | 8,239 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-sonnet-4-6 | 89,561 | 95K | 32.3M | 5,877.4M | $2,887.97 | $15,869.05 | $8,995.42 |
| claude-opus-4-6 | 7,803 | 8K | 2.6M | 651.1M | $1,634.74 | $8,790.45 | $0.00 |
| deepseek-v4-flash-free | 18,471 | 43.9M | 3.9M | 1,520.9M | $697.32 | $4,106.43 | $2,589.16 |
...
| **Total** | **178,361** | **119.9M** | **53.1M** | **11,277.4M** | **$6,687.61** | **$34,729.88** | **$17,481.63** |

_11,728.0M total tokens processed. 96.2% cache hit rate._

_$52,211.51 total saved ($34,729.88 caching + $17,481.63 model routing vs all-Opus)._
...
| Model | Requests | Input | Output | Cache read | API Cost | Cache savings | Model savings |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-sonnet-4-6 | 127,759 | 135K | 47.8M | 7,933.0M | $3,958.88 | $21,419.18 | $12,394.96 |
...
| **Total** | **248,674** | **158.3M** | **77.7M** | **15,444.6M** | **$9,584.36** | **$48,810.53** | **$23,998.65** |

_16,107.1M total tokens processed. 95.9% cache hit rate._

_$72,809.17 total saved ($48,810.53 caching + $23,998.65 model routing vs all-Opus)._
...
<!-- UPDATED-START -->
_Stats auto-updated 2026-07-25 13:03 UTC by [aidevops](https://aidevops.sh) pulse._
<!-- UPDATED-END -->
