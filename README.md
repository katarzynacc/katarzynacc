...
| Worker sessions | 271 | 1,473 | 4,453 | 6,450 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-sonnet-4-6 | 78,457 | 82K | 28.5M | 4,439.1M | $2,216.35 | $11,985.59 | $7,038.74 |
| claude-opus-4-6 | 4,241 | 4K | 1.4M | 327.3M | $770.68 | $4,418.58 | $0.00 |
...
| **Total** | **165,733** | **112.6M** | **49.3M** | **9,435.7M** | **$5,040.54** | **$26,300.36** | **$15,376.51** |

_9,829.8M total tokens processed. 96% cache hit rate._

_$41,676.87 total saved ($26,300.36 caching + $15,376.51 model routing vs all-Opus)._
...
| Model | Requests | Input | Output | Cache read | API Cost | Cache savings | Model savings |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-sonnet-4-6 | 97,006 | 102K | 36.3M | 5,351.6M | $2,720.34 | $14,449.50 | $8,605.65 |
| claude-opus-4-6 | 4,241 | 4K | 1.4M | 327.3M | $770.68 | $4,418.58 | $0.00 |
...
| claude-haiku-4-5 | 4 | 12 | 106 | 14K | $0.05 | $0.01 | $0.03 |
| **Total** | **205,300** | **129.2M** | **63.0M** | **11,790.3M** | **$6,929.05** | **$35,270.00** | **$18,870.60** |

_12,314.5M total tokens processed. 95.7% cache hit rate._

_$54,140.60 total saved ($35,270.00 caching + $18,870.60 model routing vs all-Opus)._
...
<!-- UPDATED-START -->
_Stats auto-updated 2026-07-14 11:09 UTC by [aidevops](https://aidevops.sh) pulse._
<!-- UPDATED-END -->
