...
| Worker sessions | 320 | 1,661 | 4,873 | 9,897 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-sonnet-4-6 | 101,543 | 108K | 37.0M | 7,790.5M | $3,771.49 | $21,034.48 | $11,570.05 |
...
| claude-sonnet-4-5 | 1,749 | 4K | 439K | 70.6M | $37.61 | $190.67 | $111.19 |
...
| **Total** | **147,629** | **106.7M** | **48.0M** | **11,141.3M** | **$7,291.00** | **$37,904.27** | **$16,390.34** |

_11,581.5M total tokens processed. 96.2% cache hit rate._

_$54,294.61 total saved ($37,904.27 caching + $16,390.34 model routing vs all-Opus)._
...
| Model | Requests | Input | Output | Cache read | API Cost | Cache savings | Model savings |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-sonnet-4-6 | 145,674 | 155K | 54.4M | 10,148.1M | $4,992.99 | $27,400.02 | $15,445.34 |
...
| **Total** | **276,876** | **189.2M** | **86.4M** | **18,393.5M** | **$11,381.04** | **$58,288.14** | **$28,233.81** |

_19,177.3M total tokens processed. 95.9% cache hit rate._

_$86,521.96 total saved ($58,288.14 caching + $28,233.81 model routing vs all-Opus)._
...
<!-- UPDATED-START -->
_Stats auto-updated 2026-08-04 07:51 UTC by [aidevops](https://aidevops.sh) pulse._
<!-- UPDATED-END -->
