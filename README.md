...
| Worker sessions | 364 | 1,368 | 4,998 | 8,261 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-sonnet-4-6 | 89,688 | 95K | 32.3M | 5,902.0M | $2,906.36 | $15,935.59 | $9,026.58 |
| claude-opus-4-6 | 7,804 | 8K | 2.6M | 651.1M | $1,634.99 | $8,790.45 | $0.00 |
| deepseek-v4-flash-free | 18,300 | 43.7M | 3.8M | 1,505.6M | $690.94 | $4,065.30 | $2,565.35 |
...
| **Total** | **178,318** | **119.6M** | **53.1M** | **11,286.9M** | **$6,699.87** | **$34,755.28** | **$17,488.98** |

_11,740.0M total tokens processed. 96.1% cache hit rate._

_$52,244.26 total saved ($34,755.28 caching + $17,488.98 model routing vs all-Opus)._
...
| Model | Requests | Input | Output | Cache read | API Cost | Cache savings | Model savings |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-sonnet-4-6 | 127,886 | 135K | 47.9M | 7,957.6M | $3,977.27 | $21,485.72 | $12,426.12 |
...
| **Total** | **248,802** | **158.3M** | **77.7M** | **15,469.3M** | **$9,603.00** | **$48,877.06** | **$24,029.81** |

_16,134.6M total tokens processed. 95.9% cache hit rate._

_$72,906.87 total saved ($48,877.06 caching + $24,029.81 model routing vs all-Opus)._
...
<!-- UPDATED-START -->
_Stats auto-updated 2026-07-25 17:03 UTC by [aidevops](https://aidevops.sh) pulse._
<!-- UPDATED-END -->
