...
| Worker sessions | 217 | 1,435 | 5,138 | 11,316 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-sonnet-4-6 | 54,920 | 59K | 20.6M | 6,307.4M | $3,040.37 | $17,030.21 | $8,808.78 |
...
| gpt-5.6-luna | 3,434 | 29.1M | 229K | 47.5M | $7.83 | $128.28 | $420.78 |
| claude-haiku-4-5 | 1,007 | 5K | 205K | 56.3M | $6.74 | $40.56 | $94.69 |
| **Total** | **73,548** | **94.0M** | **25.1M** | **7,791.1M** | **$4,743.02** | **$25,564.91** | **$11,392.22** |

_8,151.9M total tokens processed. 95.6% cache hit rate._

_$36,957.13 total saved ($25,564.91 caching + $11,392.22 model routing vs all-Opus)._
...
| Model | Requests | Input | Output | Cache read | API Cost | Cache savings | Model savings |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-sonnet-4-6 | 157,696 | 169K | 57.8M | 13,891.9M | $6,694.25 | $37,508.40 | $20,144.08 |
...
| **Total** | **236,693** | **221.0M** | **76.6M** | **19,453.6M** | **$12,248.53** | **$64,545.66** | **$28,892.20** |

_20,279.7M total tokens processed. 95.9% cache hit rate._

_$93,437.86 total saved ($64,545.66 caching + $28,892.20 model routing vs all-Opus)._
...
<!-- UPDATED-START -->
_Stats auto-updated 2026-09-02 03:02 UTC by [aidevops](https://aidevops.sh) pulse._
<!-- UPDATED-END -->
