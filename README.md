...
| Worker sessions | 201 | 918 | 4,347 | 7,283 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-sonnet-4-6 | 92,343 | 97K | 33.8M | 5,803.7M | $2,836.95 | $15,670.20 | $8,996.83 |
...
| gpt-5.6-terra | 232 | 879K | 41K | 10.9M | $5.81 | $29.58 | $26.20 |
| north-mini-code-free | 42 | 1.3M | 1K | 0 | $4.06 | $0.00 | $15.80 |
| gpt-5.4-mini | 932 | 2.3M | 133K | 46.9M | $2.58 | $87.95 | $79.32 |
| **Total** | **179,989** | **112.3M** | **54.4M** | **11,084.9M** | **$6,443.42** | **$33,907.67** | **$17,272.78** |

_11,514.8M total tokens processed. 96.3% cache hit rate._

_$51,180.44 total saved ($33,907.67 caching + $17,272.78 model routing vs all-Opus)._
...
| Model | Requests | Input | Output | Cache read | API Cost | Cache savings | Model savings |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-sonnet-4-6 | 119,114 | 126K | 44.8M | 7,156.6M | $3,566.41 | $19,323.07 | $11,280.80 |
...
| **Total** | **238,451** | **150.0M** | **74.2M** | **14,525.1M** | **$8,980.95** | **$46,025.55** | **$22,627.50** |

_15,143.4M total tokens processed. 95.9% cache hit rate._

_$68,653.05 total saved ($46,025.55 caching + $22,627.50 model routing vs all-Opus)._
...
<!-- UPDATED-START -->
_Stats auto-updated 2026-07-21 07:25 UTC by [aidevops](https://aidevops.sh) pulse._
<!-- UPDATED-END -->
