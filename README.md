...
| Worker sessions | 248 | 1,253 | 4,883 | 8,146 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-sonnet-4-6 | 89,048 | 94K | 32.2M | 5,829.8M | $2,866.30 | $15,740.47 | $8,928.93 |
...
| **Total** | **177,871** | **119.9M** | **53.0M** | **11,230.6M** | **$6,666.45** | **$34,603.49** | **$17,416.99** |

_11,679.8M total tokens processed. 96.2% cache hit rate._

_$52,020.48 total saved ($34,603.49 caching + $17,416.99 model routing vs all-Opus)._
...
| Model | Requests | Input | Output | Cache read | API Cost | Cache savings | Model savings |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-sonnet-4-6 | 127,246 | 135K | 47.7M | 7,885.4M | $3,937.21 | $21,290.60 | $12,328.48 |
...
| **Total** | **248,161** | **158.3M** | **77.5M** | **15,397.0M** | **$9,562.69** | **$48,681.94** | **$23,932.16** |

_16,058.0M total tokens processed. 95.9% cache hit rate._

_$72,614.10 total saved ($48,681.94 caching + $23,932.16 model routing vs all-Opus)._
...
<!-- UPDATED-START -->
_Stats auto-updated 2026-07-25 00:26 UTC by [aidevops](https://aidevops.sh) pulse._
<!-- UPDATED-END -->
