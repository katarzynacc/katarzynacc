...
| Worker sessions | 361 | 1,365 | 4,995 | 8,258 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-sonnet-4-6 | 89,619 | 95K | 32.3M | 5,886.6M | $2,896.44 | $15,893.90 | $9,007.27 |
...
| **Total** | **178,344** | **119.9M** | **53.1M** | **11,279.9M** | **$6,693.44** | **$34,736.52** | **$17,483.76** |

_11,731.9M total tokens processed. 96.1% cache hit rate._

_$52,220.28 total saved ($34,736.52 caching + $17,483.76 model routing vs all-Opus)._
...
| Model | Requests | Input | Output | Cache read | API Cost | Cache savings | Model savings |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-sonnet-4-6 | 127,817 | 135K | 47.9M | 7,942.2M | $3,967.35 | $21,444.03 | $12,406.81 |
...
| **Total** | **248,732** | **158.3M** | **77.7M** | **15,453.8M** | **$9,592.83** | **$48,835.37** | **$24,010.49** |

_16,117.8M total tokens processed. 95.9% cache hit rate._

_$72,845.86 total saved ($48,835.37 caching + $24,010.49 model routing vs all-Opus)._
...
<!-- UPDATED-START -->
_Stats auto-updated 2026-07-25 16:03 UTC by [aidevops](https://aidevops.sh) pulse._
<!-- UPDATED-END -->
