...
| Worker sessions | 269 | 1,460 | 4,768 | 9,133 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-sonnet-4-6 | 98,978 | 105K | 35.6M | 7,021.1M | $3,416.71 | $18,957.02 | $10,568.35 |
...
| gpt-5.5 | 3,321 | 9.6M | 539K | 148.7M | $72.01 | $401.66 | $326.16 |
...
| **Total** | **152,502** | **109.0M** | **48.4M** | **10,715.7M** | **$6,982.79** | **$36,208.52** | **$15,999.34** |

_11,141.8M total tokens processed. 96.2% cache hit rate._

_$52,207.86 total saved ($36,208.52 caching + $15,999.34 model routing vs all-Opus)._
...
| Model | Requests | Input | Output | Cache read | API Cost | Cache savings | Model savings |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-sonnet-4-6 | 137,178 | 146K | 51.2M | 9,076.7M | $4,487.72 | $24,507.22 | $13,967.94 |
...
| **Total** | **264,770** | **176.3M** | **82.4M** | **17,072.5M** | **$10,589.32** | **$54,020.29** | **$26,345.28** |

_17,800.3M total tokens processed. 95.9% cache hit rate._

_$80,365.57 total saved ($54,020.29 caching + $26,345.28 model routing vs all-Opus)._
...
<!-- UPDATED-START -->
_Stats auto-updated 2026-08-01 00:02 UTC by [aidevops](https://aidevops.sh) pulse._
<!-- UPDATED-END -->
