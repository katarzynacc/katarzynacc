...
| Worker sessions | 413 | 1,669 | 4,985 | 9,518 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-sonnet-4-6 | 98,968 | 106K | 35.8M | 7,298.4M | $3,525.89 | $19,705.84 | $10,912.24 |
...
| claude-sonnet-4-5 | 4,893 | 11K | 1.2M | 204.9M | $108.65 | $553.35 | $320.09 |
...
| gpt-5.6-luna | 289 | 2.1M | 19K | 3.9M | $2.78 | $10.58 | $31.55 |
| gpt-5.4-mini | 519 | 1.2M | 82K | 25.5M | $1.41 | $47.95 | $43.59 |
| **Total** | **149,597** | **110.5M** | **47.9M** | **10,850.3M** | **$7,072.03** | **$36,584.94** | **$16,147.86** |

_11,278.0M total tokens processed. 96.2% cache hit rate._

_$52,732.79 total saved ($36,584.94 caching + $16,147.86 model routing vs all-Opus)._
...
| Model | Requests | Input | Output | Cache read | API Cost | Cache savings | Model savings |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-sonnet-4-6 | 139,967 | 149K | 52.3M | 9,516.6M | $4,672.32 | $25,694.84 | $14,560.02 |
...
| **Total** | **269,938** | **186.3M** | **84.0M** | **17,669.8M** | **$10,933.27** | **$55,800.82** | **$27,253.34** |

_18,420.5M total tokens processed. 95.9% cache hit rate._

_$83,054.15 total saved ($55,800.82 caching + $27,253.34 model routing vs all-Opus)._
...
<!-- UPDATED-START -->
_Stats auto-updated 2026-08-02 15:19 UTC by [aidevops](https://aidevops.sh) pulse._
<!-- UPDATED-END -->
